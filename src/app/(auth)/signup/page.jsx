 ...
 const handleGitHubSignIn = async () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="card w-full max-w-md bg-base-100 shadow-2xl border border-base-200/60 rounded-[2rem] p-4 sm:p-6 transition-all duration-300 hover:shadow-3xl mt-8 mb-8 animate__animated animate__fadeInUp animate__faster">
